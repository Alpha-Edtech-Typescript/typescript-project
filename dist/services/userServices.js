    ...
    try {
        ...
        if (team) {
            if (typeof team !== "string") {
                throw new Error("Tipo de dado inválido no team, ele deve ser um string");
            }
        }
        ...
        const user = yield userRepository.createUser(username, email, first_name, last_name, hashedPassword, team);
        return user;
    }
    catch (error) {
        throw error;
