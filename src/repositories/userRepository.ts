...
// ) => {
//   const query =
//     "INSERT INTO users (username, email, first_name, last_name, password, team, is_admin) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *";
//   try {
...
//   const query =
//     "SELECT id, username, email, first_name, last_name, password, is_admin, team  FROM users WHERE id = $1";
//   try {
//     const result = await pool.query(query, [userId]);
//     if (result.rows.length === 0) {
//       throw new Error(`Usuário com ID ${userId} não encontrado`);
//     }
//     console.log("Resultado do getUserbyId", result.rows[0]);
//     return result.rows[0] as IUser;
//   } catch (error) {
//     console.error("Erro ao buscar usuário pelo ID:", error);
//     throw new Error("Falha ao buscar usuário pelo ID");
